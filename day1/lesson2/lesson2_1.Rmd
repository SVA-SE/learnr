...
When you read data from tad delimed form, you use a similar format to
...
## View the data with the 'View' function. In R-studio you can also
## click the name of the dataset in the environment tab in the top-right
## panel of the editor
